...
var state = {
  ...
  wallPaperSrc: JSON.parse(localStorage.getItem("storageWallPaper")) ? JSON.parse(localStorage.getItem("storageWallPaper")).img : require('../../../../static/defaultWallPapers/moren.jpg')
}; // getters
